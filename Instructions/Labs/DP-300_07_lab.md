...
**前提条件**: 演習 2 で使用した Azure SQL データベースは、モジュール 3 のラボで作成されました。 
...
# 演習 2: Azure SQL データベースの geo レプリケーションを有効にする

概要

受講者は、モジュール 3 のラボで作成した Azure SQL データベースの構成を変更して、高可用性を実現します。
